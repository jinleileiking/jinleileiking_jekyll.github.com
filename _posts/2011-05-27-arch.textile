...
* usermod -a jinleileiking -G root,bin,adm,tty,disk,mem,kmem,ftp,mail,uucp,log,utmp,locate,rfkill,smmsp,http,network,floppy,nobody,users,dbus,avahi,camera,usbmux,sys
